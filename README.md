...
<p align="center">
  <strong>A parallel computing assignment implementing statistical calculations on a vector using MPI.</strong>
</p>
...
* **Memory Management:** Each processor only allocates memory for the portion of data it processes (Local $X$, Local $\delta$). The Master node (Rank 0) handles I/O and final result aggregation.
